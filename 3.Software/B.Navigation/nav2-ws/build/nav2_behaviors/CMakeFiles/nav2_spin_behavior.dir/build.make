...
CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.o: /root/nav2-ws/src/navigation2/nav2_behaviors/plugins/spin.cpp
CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.o: CMakeFiles/nav2_spin_behavior.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/nav2-ws/build/nav2_behaviors/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.o"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.o -MF CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.o.d -o CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.o -c /root/nav2-ws/src/navigation2/nav2_behaviors/plugins/spin.cpp
...
CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/nav2-ws/src/navigation2/nav2_behaviors/plugins/spin.cpp > CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.i
...
CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/nav2-ws/src/navigation2/nav2_behaviors/plugins/spin.cpp -o CMakeFiles/nav2_spin_behavior.dir/plugins/spin.cpp.s
...
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_costmap_2d/lib/liblayers.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_costmap_2d/lib/libfilters.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_costmap_2d/lib/libnav2_costmap_2d_client.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_behavior_tree.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_compute_path_to_pose_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_compute_path_through_poses_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_controller_cancel_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_wait_cancel_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_spin_cancel_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_back_up_cancel_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_assisted_teleop_cancel_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_drive_on_heading_cancel_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_smooth_path_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_follow_path_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_back_up_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_drive_on_heading_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_spin_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_wait_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_assisted_teleop_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_clear_costmap_service_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_is_stuck_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_transform_available_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_goal_reached_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_globally_updated_goal_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_goal_updated_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_is_path_valid_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_time_expired_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_path_expiring_timer_condition.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_distance_traveled_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_initial_pose_received_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_is_battery_charging_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_is_battery_low_condition_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_reinitialize_global_localization_service_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_rate_controller_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_distance_controller_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_speed_controller_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_truncate_path_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_truncate_path_local_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_goal_updater_node_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_path_longer_on_approach_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_recovery_node_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_navigate_to_pose_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_navigate_through_poses_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_remove_passed_goals_action_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_pipeline_sequence_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_round_robin_node_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_single_trigger_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_planner_selector_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_controller_selector_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_smoother_selector_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_goal_checker_selector_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_progress_checker_selector_bt_node.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_behavior_tree/lib/libnav2_goal_updated_controller_bt_node.so
...
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_costmap_2d/lib/liblayers.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_costmap_2d/lib/libfilters.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_costmap_2d/lib/libnav2_costmap_2d_core.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_costmap_2d/lib/libnav2_costmap_2d_client.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_util/lib/libnav2_util_core.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_generator_c.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_fastrtps_c.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_fastrtps_cpp.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_introspection_c.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_c.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_introspection_cpp.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_cpp.so
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_generator_py.so
...
libnav2_spin_behavior.so: /root/nav2-ws/install/nav2_voxel_grid/lib/libvoxel_grid.so
...
libnav2_spin_behavior.so: CMakeFiles/nav2_spin_behavior.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/nav2-ws/build/nav2_behaviors/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX shared library libnav2_spin_behavior.so"
