...
set(_exported_libraries "nav2_smac_planner;nav2_smac_planner_2d;nav2_smac_planner_lattice")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'nav2_smac_planner' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND nav2_smac_planner_LIBRARIES ${_cfg} "${_lib}")
