...
static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__DummyBehavior_Result__rosidl_typesupport_introspection_c__DummyBehavior_Result_message_member_array[1] = {
  {
