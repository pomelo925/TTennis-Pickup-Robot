...
test/regression/CMakeFiles/plugin_api_order.dir/plugin_api_order.cpp.o: /root/nav2-ws/src/navigation2/nav2_costmap_2d/test/regression/plugin_api_order.cpp
test/regression/CMakeFiles/plugin_api_order.dir/plugin_api_order.cpp.o: test/regression/CMakeFiles/plugin_api_order.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/nav2-ws/build/nav2_costmap_2d/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/regression/CMakeFiles/plugin_api_order.dir/plugin_api_order.cpp.o"
...
test/regression/CMakeFiles/plugin_api_order.dir/plugin_api_order.cpp.i: cmake_force
	...
	cd /root/nav2-ws/build/nav2_costmap_2d/test/regression && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/nav2-ws/src/navigation2/nav2_costmap_2d/test/regression/plugin_api_order.cpp > CMakeFiles/plugin_api_order.dir/plugin_api_order.cpp.i
...
test/regression/CMakeFiles/plugin_api_order.dir/plugin_api_order.cpp.s: cmake_force
	...
	cd /root/nav2-ws/build/nav2_costmap_2d/test/regression && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/nav2-ws/src/navigation2/nav2_costmap_2d/test/regression/plugin_api_order.cpp -o CMakeFiles/plugin_api_order.dir/plugin_api_order.cpp.s
...
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_fastrtps_c.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_fastrtps_cpp.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_introspection_c.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_introspection_cpp.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_cpp.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_generator_py.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_c.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_generator_c.so
...
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_util/lib/libnav2_util_core.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_generator_c.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_fastrtps_c.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_fastrtps_cpp.so
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_msgs/lib/libnav2_msgs__rosidl_typesupport_introspection_c.so
...
test/regression/plugin_api_order: /root/nav2-ws/install/nav2_voxel_grid/lib/libvoxel_grid.so
test/regression/plugin_api_order: /opt/ros/humble/lib/libsensor_msgs__rosidl_generator_c.so
test/regression/plugin_api_order: /opt/ros/humble/lib/libsensor_msgs__rosidl_typesupport_fastrtps_c.so
test/regression/plugin_api_order: /opt/ros/humble/lib/libsensor_msgs__rosidl_typesupport_fastrtps_cpp.so
test/regression/plugin_api_order: /opt/ros/humble/lib/libsensor_msgs__rosidl_typesupport_introspection_c.so
...
test/regression/plugin_api_order: test/regression/CMakeFiles/plugin_api_order.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/nav2-ws/build/nav2_costmap_2d/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable plugin_api_order"
	cd /root/nav2-ws/build/nav2_costmap_2d/test/regression && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/plugin_api_order.dir/link.txt --verbose=$(VERBOSE)
...
test/regression/CMakeFiles/plugin_api_order.dir/clean:
	cd /root/nav2-ws/build/nav2_costmap_2d/test/regression && $(CMAKE_COMMAND) -P CMakeFiles/plugin_api_order.dir/cmake_clean.cmake
