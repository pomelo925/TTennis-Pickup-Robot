...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/root/comm-ws/src/firmware_commun/src/rosserial_server/include".split(';') if "/root/comm-ws/src/firmware_commun/src/rosserial_server/include" != "" else []
...
PROJECT_SPACE_DIR = "/root/comm-ws/devel"
