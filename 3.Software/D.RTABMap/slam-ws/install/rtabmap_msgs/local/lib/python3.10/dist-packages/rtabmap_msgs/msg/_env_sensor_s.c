...
bool rtabmap_msgs__msg__env_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_msgs.msg._env_sensor.EnvSensor", full_classname_dest, 38) == 0);
  }
  rtabmap_msgs__msg__EnvSensor * ros_message = _ros_message;
  {  // header
...
PyObject * rtabmap_msgs__msg__env_sensor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_msgs.msg._env_sensor");
