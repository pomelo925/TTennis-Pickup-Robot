...
bool rtabmap_msgs__msg__landmark_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_msgs.msg._landmark_detection.LandmarkDetection", full_classname_dest, 54) == 0);
  }
  rtabmap_msgs__msg__LandmarkDetection * ros_message = _ros_message;
  {  // header
  ...
  {  // landmark_frame_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "landmark_frame_id");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->landmark_frame_id, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of LandmarkDetection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_msgs.msg._landmark_detection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LandmarkDetection");
  ...
  {  // landmark_frame_id
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->landmark_frame_id.data,
      strlen(ros_message->landmark_frame_id.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "landmark_frame_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
