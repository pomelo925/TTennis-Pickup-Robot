...
bool rtabmap_msgs__msg__path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_msgs.msg._path.Path", full_classname_dest, 27) == 0);
  }
  rtabmap_msgs__msg__Path * ros_message = _ros_message;
  {  // header
...
PyObject * rtabmap_msgs__msg__path__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_msgs.msg._path");
