...
bool rtabmap_msgs__msg__camera_model__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_msgs.msg._camera_model.CameraModel", full_classname_dest, 42) == 0);
  }
  rtabmap_msgs__msg__CameraModel * ros_message = _ros_message;
  {  // camera_info
...
PyObject * rtabmap_msgs__msg__camera_model__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_msgs.msg._camera_model");
